...
RETURNING id, character_id, name, quantity, weight, description, value, is_equipped, requires_attunement, is_attuned, created_at
`
...
SELECT id, character_id, name, quantity, weight, description, value, is_equipped, requires_attunement, is_attuned, created_at FROM inventory_items
WHERE id = $1
`
