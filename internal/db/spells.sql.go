...
RETURNING id, character_id, name, level, school, casting_time, range, components, duration, description, is_prepared, created_at, updated_at
`
...
SELECT id, character_id, name, level, school, casting_time, range, components, duration, description, is_prepared, created_at, updated_at FROM spells
WHERE id = $1
`
