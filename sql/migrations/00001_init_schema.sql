...
CREATE TABLE characters (
    ...
    skill_acrobatics      INTEGER NOT NULL DEFAULT 0 CHECK (skill_acrobatics      BETWEEN 0 AND 2),
    skill_animal_handling INTEGER NOT NULL DEFAULT 0 CHECK (skill_animal_handling BETWEEN 0 AND 2),
    skill_arcana          INTEGER NOT NULL DEFAULT 0 CHECK (skill_arcana          BETWEEN 0 AND 2),
    skill_athletics       INTEGER NOT NULL DEFAULT 0 CHECK (skill_athletics       BETWEEN 0 AND 2),
    skill_deception       INTEGER NOT NULL DEFAULT 0 CHECK (skill_deception       BETWEEN 0 AND 2),
    skill_history         INTEGER NOT NULL DEFAULT 0 CHECK (skill_history         BETWEEN 0 AND 2),
    skill_insight         INTEGER NOT NULL DEFAULT 0 CHECK (skill_insight         BETWEEN 0 AND 2),
    skill_intimidation    INTEGER NOT NULL DEFAULT 0 CHECK (skill_intimidation    BETWEEN 0 AND 2),
    skill_investigation   INTEGER NOT NULL DEFAULT 0 CHECK (skill_investigation   BETWEEN 0 AND 2),
    skill_medicine        INTEGER NOT NULL DEFAULT 0 CHECK (skill_medicine        BETWEEN 0 AND 2),
    skill_nature          INTEGER NOT NULL DEFAULT 0 CHECK (skill_nature          BETWEEN 0 AND 2),
    skill_perception      INTEGER NOT NULL DEFAULT 0 CHECK (skill_perception      BETWEEN 0 AND 2),
    skill_performance     INTEGER NOT NULL DEFAULT 0 CHECK (skill_performance     BETWEEN 0 AND 2),
    skill_persuasion      INTEGER NOT NULL DEFAULT 0 CHECK (skill_persuasion      BETWEEN 0 AND 2),
    skill_religion        INTEGER NOT NULL DEFAULT 0 CHECK (skill_religion        BETWEEN 0 AND 2),
    skill_sleight_of_hand INTEGER NOT NULL DEFAULT 0 CHECK (skill_sleight_of_hand BETWEEN 0 AND 2),
    skill_stealth         INTEGER NOT NULL DEFAULT 0 CHECK (skill_stealth         BETWEEN 0 AND 2),
    skill_survival        INTEGER NOT NULL DEFAULT 0 CHECK (skill_survival        BETWEEN 0 AND 2),
